module.exports = function(grunt) {
  ...
  grunt.initConfig({
    concat: {
      ...
      WebReflection: {
        src: WebReflectionFiles,
        dest: 'doc/lib/register-element.js'
      }
    },
    uglify: {
      all: {
        files: {
          'doc/lib/register-element.min.js': ['doc/lib/register-element.js'],
  ...
  grunt.registerTask('default', ['concat:WebReflection','uglify']);
};
